...
export type RunSummary = { id: string; pathId: string; pathName: string; version: number; status: string; snapshot: Snapshot; sourcePostId: string; qualified: boolean; qualificationReasons: string[]; lastInteractionAt: string | null; createdAt: string };
