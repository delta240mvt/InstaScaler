...
export default function ReportPage() {
  ...
  return <main className="min-h-screen bg-background"><div className="mx-auto max-w-6xl space-y-7 px-5 py-8 sm:px-8 sm:py-12">
    <nav className="flex items-center gap-2 text-sm font-bold tracking-tight"><span className="flex size-9 items-center justify-center rounded-xl bg-accent text-white"><Icon name="campaigns" size={18} /></span>InstaScaler</nav>
